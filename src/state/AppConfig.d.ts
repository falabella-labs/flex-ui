...
/**
 * Logger type
 * @enum {"file"} Configuration.LoggerType
 ...
 * @typedef Configuration.Notifications
 ...
 * @property {Configuration.SSOConfig} [sso] SSO configuration
 ...
 * @property {Configuration.LoggerType} [logger.type] type of the logger
